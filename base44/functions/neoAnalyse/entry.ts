...
Deno.serve(async (req) => {
  try {
    ...
    const [
      ...
      base44.asServiceRole.entities.CourseExterne.list('-created_date', 500).catch(() => []),
      base44.asServiceRole.entities.Livreur.list('-created_date', 500).catch(() => []),
      base44.asServiceRole.entities.ClientExterne.list('-created_date', 500).catch(() => []),
      base44.asServiceRole.entities.Boutique.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.Restaurant.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.Pharmacie.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.Message.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.Notification.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.RapportMaintenance.list('-created_date', 10).catch(() => []),
      base44.asServiceRole.entities.VenusInteraction.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.AppInstall.list('-created_date', 500).catch(() => []),
      base44.asServiceRole.entities.User.list('-created_date', 100).catch(() => []),
      base44.asServiceRole.entities.CommandeBoutique.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.CommandeRestaurant.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.PaiementPartenaire.list('-created_date', 200).catch(() => []),
      base44.asServiceRole.entities.NotificationToken.list('-created_date', 500).catch(() => []),
      base44.asServiceRole.entities.Conversation.list('-created_date', 100).catch(() => []),
      base44.asServiceRole.entities.CodePromo.list('-created_date', 100).catch(() => []),
      base44.asServiceRole.entities.PrimePromo.list('-created_date', 100).catch(() => []),
    ]);
