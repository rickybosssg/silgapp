...
La commission et le gain livreur sont configurés dynamiquement dans Admin > Pays.
...
4. Ne jamais inventer un taux de commission : utiliser uniquement la configuration du pays actif
