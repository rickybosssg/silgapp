...
const FALLBACK_PAYS: Record<string, CountryConfig> = {
  ...
  CI: { code: 'CI', nom: "Côte d'Ivoire", indicatif: '+225', devise: 'XOF', devise_symbole: 'FCFA', fuseau_horaire: 'Africa/Abidjan', langue_principale: 'fr', langues_officielles: ['fr'], langues_secondaires: ['dioula'], prix_par_km: 120, prix_minimum: 1000, commission_pct: null, ville_principale: 'Abidjan', rayon_km: 40, support_telephone: '+225 07 00 00 00', modes_paiement: ['orange_money', 'mtn', 'moov', 'wave', 'especes'], format_adresse: 'quartier_rue', horaires_service: {}, politiques_locales: {}, emoji_flag: '🇨🇮', actif: true },
  TG: { code: 'TG', nom: 'Togo', indicatif: '+228', devise: 'XOF', devise_symbole: 'FCFA', fuseau_horaire: 'Africa/Lome', langue_principale: 'fr', langues_officielles: ['fr'], langues_secondaires: ['ewe'], prix_par_km: 100, prix_minimum: 1000, commission_pct: null, ville_principale: 'Lomé', rayon_km: 25, support_telephone: '+228 90 00 00 00', modes_paiement: ['moov', 'togocom', 'especes'], format_adresse: 'quartier_rue', horaires_service: {}, politiques_locales: {}, emoji_flag: '🇹🇬', actif: true },
  BJ: { code: 'BJ', nom: 'Bénin', indicatif: '+229', devise: 'XOF', devise_symbole: 'FCFA', fuseau_horaire: 'Africa/Porto-Novo', langue_principale: 'fr', langues_officielles: ['fr'], langues_secondaires: ['fon', 'yoruba'], prix_par_km: 100, prix_minimum: 1000, commission_pct: null, ville_principale: 'Cotonou', rayon_km: 25, support_telephone: '+229 90 00 00 00', modes_paiement: ['mtn', 'moov', 'especes'], format_adresse: 'quartier_rue', horaires_service: {}, politiques_locales: {}, emoji_flag: '🇧🇯', actif: true },
  SN: { code: 'SN', nom: 'Sénégal', indicatif: '+221', devise: 'XOF', devise_symbole: 'FCFA', fuseau_horaire: 'Africa/Dakar', langue_principale: 'fr', langues_officielles: ['fr'], langues_secondaires: ['wolof'], prix_par_km: 150, prix_minimum: 1000, commission_pct: null, ville_principale: 'Dakar', rayon_km: 35, support_telephone: '+221 77 00 00 00', modes_paiement: ['orange_money', 'wave', 'especes'], format_adresse: 'quartier_rue', horaires_service: {}, politiques_locales: {}, emoji_flag: '🇸🇳', actif: true },
  ML: { code: 'ML', nom: 'Mali', indicatif: '+223', devise: 'XOF', devise_symbole: 'FCFA', fuseau_horaire: 'Africa/Bamako', langue_principale: 'fr', langues_officielles: ['fr'], langues_secondaires: ['bambara', 'fulfulde'], prix_par_km: 100, prix_minimum: 1000, commission_pct: null, ville_principale: 'Bamako', rayon_km: 30, support_telephone: '+223 70 00 00 00', modes_paiement: ['orange_money', 'moov', 'especes'], format_adresse: 'quartier_rue', horaires_service: {}, politiques_locales: {}, emoji_flag: '🇲🇱', actif: true },
  GN: { code: 'GN', nom: 'Guinée', indicatif: '+224', devise: 'GNF', devise_symbole: 'GNF', fuseau_horaire: 'Africa/Conakry', langue_principale: 'fr', langues_officielles: ['fr'], langues_secondaires: ['fulfulde', 'malinke'], prix_par_km: 800, prix_minimum: 4000, commission_pct: null, ville_principale: 'Conakry', rayon_km: 30, support_telephone: '+224 620 00 00 00', modes_paiement: ['orange_money', 'mtn', 'especes'], format_adresse: 'quartier_rue', horaires_service: {}, politiques_locales: {}, emoji_flag: '🇬🇳', actif: true },
  NE: { code: 'NE', nom: 'Niger', indicatif: '+227', devise: 'XOF', devise_symbole: 'FCFA', fuseau_horaire: 'Africa/Niamey', langue_principale: 'fr', langues_officielles: ['fr'], langues_secondaires: ['haoussa', 'djerma'], prix_par_km: 100, prix_minimum: 1000, commission_pct: null, ville_principale: 'Niamey', rayon_km: 25, support_telephone: '+227 90 00 00 00', modes_paiement: ['orange_money', 'moov', 'especes'], format_adresse: 'quartier_rue', horaires_service: {}, politiques_locales: {}, emoji_flag: '🇳🇪', actif: true },
