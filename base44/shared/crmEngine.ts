...
import { normalizePhone, loadCountryDialCodes } from './phoneUtils.ts';

// Re-export pour compatibilité — les fonctions backend importent normalizePhone depuis crmEngine.ts
export { normalizePhone };

/**
 * Précharge les indicatifs téléphoniques depuis Country.indicatif.
 * Délègue à loadCountryDialCodes (source de vérité = phoneUtils.ts).
 */
