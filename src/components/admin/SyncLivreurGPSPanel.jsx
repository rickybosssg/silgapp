...
import { Truck, CheckCircle, AlertCircle, Loader2, MapPin } from "lucide-react";
import { toast } from "sonner";

export default function SyncLivreurGPSPanel() {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Synchronisation GPS des livreurs externes
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="text-sm text-muted-foreground">
          Cette fonction vérifie le statut GPS de tous les livreurs externes.
          <br />
        ...
        >
          {syncing ? (
            ...
            <>
              ...
              Vérifier le statut GPS de tous les livreurs
            </>
          )}
        </Button>
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-3 gap-3">
              <div className="p-3 rounded-lg bg-blue-50 border border-blue-200">
                <p className="text-xs text-blue-700 font-semibold">Total livreurs</p>
              ...
              <div className="p-3 rounded-lg bg-amber-50 border border-amber-200">
                ...
                <p className="text-2xl font-bold text-amber-900">{stats.stats?.sans_gps || 0}</p>
              </div>
            </div>
