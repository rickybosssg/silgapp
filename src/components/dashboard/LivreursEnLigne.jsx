...
// Reçoit directement les livreurs déjà filtrés (en ligne = non hors_ligne, validés, actifs)
  ...
  return (
    <Card className="p-4">
      <div className="flex items-center justify-between mb-3">
        <h2 className="font-semibold text-sm flex items-center gap-2">
          <Truck className="w-4 h-4 text-primary" /> Livreurs en ligne
          <span className="text-xs bg-primary/10 text-primary font-semibold px-1.5 py-0.5 rounded-full">{livreurs.length}</span>
        </h2>
          ...
          return (
            ...
            >
              ...
              <span className={cn(
                ...
                isDispo ? "bg-green-500" : "bg-orange-500"
              )} />
