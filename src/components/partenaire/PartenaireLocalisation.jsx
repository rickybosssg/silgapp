  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      const icon = window.L.divIcon({
        html: `<div style="width:36px;height:36px;background:white;border:3px solid ${color};border-radius:50%;box-shadow:0 2px 8px rgba(0,0,0,0.2);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:800;color:${color}">${isRestaurant ? "R" : "B"}</div>`,
        className: "",
        iconSize: [36, 36],
        iconAnchor: [18, 18],
      });
