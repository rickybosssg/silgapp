...
const CONFIG = {
  ...
  en_attente: { label: "En attente", color: "bg-gray-100 text-gray-600 border-gray-200" },
  ...
  disponible_push: { label: "Disponible (fil)", color: "bg-teal-100 text-teal-700 border-teal-200" },
  redispatch: { label: "Redispatch requis", color: "bg-orange-100 text-orange-700 border-orange-200" },
  cycle_epuise: { label: "Cycle épuisé", color: "bg-red-100 text-red-700 border-red-200" },
};
