...
export const navItems = [
  ...
  { path: "/admin/boutiques", label: "Gestion Boutiques", icon: Store, reseauOnly: "externe" },
  { path: "/admin/restaurants", label: "Gestion Restaurants", icon: UtensilsCrossed, reseauOnly: "externe" },
