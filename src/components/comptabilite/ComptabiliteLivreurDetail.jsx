...
import { X, Phone, MapPin, TrendingUp, Banknote, AlertTriangle, CheckCircle, Clock } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-lg max-h-[85vh] bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="px-4 pb-2 flex items-center gap-2">
          ...
          {dusNonPayes > 0 && <Badge className="bg-amber-100 text-amber-700">⚠️ {formatMontant(dusNonPayes)} non payé</Badge>}
