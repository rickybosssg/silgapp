...
import { ArrowLeft, Store, MapPin, Plus, Minus, ShoppingCart, Loader2, Package, X } from "lucide-react";
                ...
                <div key={p.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-3 flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {(p.photos_urls || p.video_url) && (
                      <p className="text-[10px] text-blue-500 font-medium mt-0.5">📷 Voir les médias</p>
                    )}
                  </div>
                  {isOuvert && (
                    inCart ? (
