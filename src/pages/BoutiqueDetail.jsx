...
import { ArrowLeft, MapPin, Plus, Minus, ShoppingCart, Loader2, Package, Clock } from "lucide-react";
            ...
            {produits.map(p => {
              ...
              return (
                <div key={p.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-3 flex items-center gap-3">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center overflow-hidden flex-shrink-0">
