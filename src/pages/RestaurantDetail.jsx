...
import { ArrowLeft, UtensilsCrossed, MapPin, Plus, Minus, ShoppingCart, Loader2, Clock, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="max-w-lg mx-auto px-4 py-4 space-y-4">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-2">
          ...
          {restaurant.horaires && <p className="text-xs text-gray-500">🕐 {restaurant.horaires}</p>}
                    ...
                    <div key={p.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-3 flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {(p.photos_urls || p.video_url) && (
                          <p className="text-[10px] text-orange-500 font-medium mt-0.5">📷 Voir les médias</p>
                        )}
                      </div>
                      {isOuvert && (
                        inCart ? (
