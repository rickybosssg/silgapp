...
import { UtensilsCrossed, Plus, Pencil, Trash2, Loader2, ArrowLeft, Eye } from "lucide-react";
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex gap-2 mt-1 flex-wrap">
                ...
                {r.commission_pct != null && (
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full text-purple-600 bg-purple-50">{r.commission_pct}%</span>
                )}
              </div>
            </div>
            <div className="flex gap-1 flex-shrink-0">
              <button onClick={() => setDetailItem(r)} className="p-2 rounded-lg hover:bg-purple-50"><Eye className="w-4 h-4 text-purple-500" /></button>
